...
2026-09-25T20:33, R1..R39 and DP-1..DP-3),
`../context/05-dash-linear-interfaces.md` (2026-09-18T16:15),
`../context/02-actors.md` (2026-09-25T19:49) and
`../context/99-glossary.md` (2026-09-25T19:49). Total rows: 15 — every
...
- Requirements with no runtime failure mode: the governance set (R8, R9,
  R10), VAST independence (R11) and base-first precedence (R1.5).
  Violating one is non-conformance of the spec document, not a
  condition to which a Player response can be assigned.
...
cap on every slot (R4.1), allowed layouts from the closed token list and
