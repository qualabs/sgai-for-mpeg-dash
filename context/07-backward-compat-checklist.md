...
| *(non-linear listen-mode termination signal — deferred to follow-up PR; see PROJECT.md open thread)* | — | — | — | — | — | — | DEFERRED |
...
- **Listen-mode slot with no termination mechanism.** A slot
  ...
  activation is permitted (MAY) per ADR-01 in
  [`.project/decisions/`](./decisions/01-listen-mode-safety-cap.md).
